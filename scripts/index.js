...
let formEditElement = document.querySelector('.popup__edit-container'); // Находим форму в DOM
...
let formAddElement = document.querySelector('.popup__add-container'); // Находим форму в DOM
